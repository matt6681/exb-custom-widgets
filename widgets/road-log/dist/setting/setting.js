            ...
            jimu_core__WEBPACK_IMPORTED_MODULE_0__.React.createElement("div", { style: eventListStyle }, discoveredLayers.map(layer => {
                ...
                return (jimu_core__WEBPACK_IMPORTED_MODULE_0__.React.createElement("div", { key: layer.id, style: { marginBottom: '10px' } },
                    ...
                    isSelected && layer.fields.length > 0 && (jimu_core__WEBPACK_IMPORTED_MODULE_0__.React.createElement("div", { style: fieldPickerStyle },
                        jimu_core__WEBPACK_IMPORTED_MODULE_0__.React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '3px', marginBottom: '4px' } },
                            jimu_core__WEBPACK_IMPORTED_MODULE_0__.React.createElement("input", { type: "text", placeholder: "Search...", value: getFieldSearch(layer.id), onChange: (e) => setLayerFieldSearch(layer.id, e.target.value), style: { flex: 1, minWidth: 0, padding: '2px 4px', fontSize: '10px', border: '1px solid #ccc', borderRadius: '3px', color: '#000', backgroundColor: '#fff' } }),
